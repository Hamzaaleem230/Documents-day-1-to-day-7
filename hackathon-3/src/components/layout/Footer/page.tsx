...
const socialsData: SocialNetworks[] = [
  ...
  },
  {
    id: 2,
    icon: <FaFacebookF />,
    url: "https://www.facebook.com/hikmat.jan.547389?mibextid=ZbWKwL",
  },
  {
    id: 3,
    icon: <FaInstagram />,
    url: "https://www.instagram.com/hikmatkhanachakzai1?igsh=MTdvMjV0bjVoNHV5aQ==",
  },
  {
    id: 4,
    icon: <FaGithub />,
    url: "https://github.com/hikmatkhan090",
  },
];
        ...
        <div className="max-w-frame mx-auto">
          <nav className="lg:grid lg:grid-cols-12 mb-8">
            <div className="flex flex-col lg:col-span-3 lg:max-w-[248px]">
              ...
              We have clothes that suit your style and make you proud to wear them—perfect for both men & women.
              </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center sm:justify-between items-center mb-2">
            ...
            Shop.co © | All Rights Reserved | HIKMAT KHAN
